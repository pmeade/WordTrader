...
{
    private Dictionary<EWordClass, string[]> Words = new Dictionary<EWordClass, string[]>();

    private void Start()
    {
        Words[EWordClass.Common] = connectivityWords;
        Words[EWordClass.Short] = shortWords;
        Words[EWordClass.Full] = remainingWords;
        Words[EWordClass.Uncommon] = uncommonWords;
    }

    public string Next(EWordClass eWordClass)
    {
        if (Words[eWordClass].Length > 0)
        {
            return Words[eWordClass][Random.Range(0, Words[eWordClass].Length)];
        }

        return "bilgewater";
    }

    private string[] uncommonWords = new string[]
    {
        "vex"
    };
    
    
           string[] connectivityWords = new string[]
        {
            "a", "about", "after", "all", "along", "also", "an", "and", "another", "any", "are", "as", "at", "be",
            "because", "before", "but", "by", "can", "could", "do", "does", "each", "for", "from", "had", "has", "have",
            "he", "her", "him", "his", "how", "I", "if", "in", "into", "is", "it", "its", "me", "more", "my", "no",
            "not", "of", "on", "one", "or", "other", "our", "out", "over", "said", "she", "so", "some", "than", "that",
            "the", "their", "them", "then", "there", "these", "they", "this", "to", "up", "was", "we", "what", "when",
            "which", "who", "will", "with", "would", "you", "your"
            // Add more connectivity words if needed
        };

        string[] shortWords = new string[]
        {
            "am", "an", "at", "be", "by", "do", "go", "he", "if", "in", "is", "it", "me", "my", "no", "of", "on", "or",
            "so", "to", "up", "us", "we"
            // Ensure all short 1, 2, 3 letter words are included
        };

        string[] remainingWords = new string[]
        {
            "ability", "able", "above", "accept", "according", "account", "across", "act", "action", "activity",
            ...
            "along", "already", "although", "always", "American", "among", "amount", "analysis", "and", "animal",
            "another", "answer", "anyone", "anything", "appear", "apply", "approach", "area", "argue", "arm", "around",
            "arrive", "art", "article", "artist", "as", "ask", "assume", "at", "attack", "attention", "attorney",
            "audience", "author", "authority", "available", "avoid", "away", "baby", "back", "bad", "bag", "ball",
            "bank", "bar", "base", "be", "beat", "beautiful", "because", "become", "bed", "before", "begin", "behavior",
            ...
            "brother", "budget", "build", "building", "business", "but", "buy", "call", "camera", "campaign", "can",
            "cancer", "capital", "car", "card", "care", "career", "carry", "case", "catch", "cause", "cell", "center",
            ...
            "finish", "fire", "firm", "first", "fish", "five", "floor", "fly", "focus", "follow", "food", "foot", "for",
            ...
            "into", "investment", "involve", "issue", "it", "item", "its", "itself", "job", "join", "just", "keep",
            "key", "kid", "kill", "kind", "kitchen", "know", "knowledge", "land", "language", "large", "last", "late",
            ...
            "network", "never", "new", "news", "next", "nice", "night", "no", "none", "nor", "north", "not", "note",
            "nothing", "notice", "now", "number", "occur", "off", "offer", "office", "officer", "official", "often",
            "oil", "old", "on", "once", "one", "only", "onto", "open", "operation", "opportunity", "option", "or",
